FROM debian:jessie
ARG version=200217097
# --build-arg version=200217097
...
WORKDIR /tmp
RUN apt-get -y install libxdamage1 libgtk-3-0 libasound2 libnss3 libxss1 sudo bzip2 wget expect libxdamage1 libgtk-3-0 libasound2 libnss3 libxss1 libx11-xcb1;\
